...
![](0.inspect-profiles_files/figure-gfm/unnamed-chunk-19-2.png)<!-- -->

``` r
plot_replicate_correlations_platemap(augmented_profiles_isolated, "isolated")
```

![](0.inspect-profiles_files/figure-gfm/unnamed-chunk-19-3.png)<!-- -->
...
![](0.inspect-profiles_files/figure-gfm/unnamed-chunk-25-2.png)<!-- -->

``` r
plot_and_save_similarities(similarity = filter_cell_lines(similarity_isolated), profile_type = "isolated_filtered")
```

![](0.inspect-profiles_files/figure-gfm/unnamed-chunk-25-3.png)<!-- -->
