...
![](0.inspect-profiles_files/figure-gfm/unnamed-chunk-11-1.png)<!-- -->
...
![](0.inspect-profiles_files/figure-gfm/unnamed-chunk-12-1.png)<!-- -->
...
![](0.inspect-profiles_files/figure-gfm/unnamed-chunk-14-1.png)<!-- -->
...
```
    ...
    ## # A tibble: 3 x 2
    ##   profile_type `Pearson corr. between cell line id and replicate correlati…
    ##   <chr>                                                               <dbl>
    ## 1 ""                                                                  0.150
    ## 2 _colony                                                             0.165
    ## 3 _isolated                                                           0.206
...
![](0.inspect-profiles_files/figure-gfm/unnamed-chunk-15-1.png)<!-- -->
...
```
    ...
    ## # A tibble: 3 x 2
    ##   profile_type `Pearson corr. between cell count and replicate correlation`
    ##   <chr>                                                               <dbl>
    ## 1 ""                                                                 -0.272
    ## 2 _colony                                                            -0.363
    ## 3 _isolated                                                          -0.355
...
![](0.inspect-profiles_files/figure-gfm/unnamed-chunk-18-1.png)<!-- -->
...
![](0.inspect-profiles_files/figure-gfm/unnamed-chunk-18-2.png)<!-- -->
...
![](0.inspect-profiles_files/figure-gfm/unnamed-chunk-18-3.png)<!-- -->
...
Note that the cell counts here are that of all cells from the well, not
that of each profile type (i.e. we don’t computer cell counts for
`isolated` and `colony`, we just use the cell counts for the whole well)
...
![](0.inspect-profiles_files/figure-gfm/unnamed-chunk-24-1.png)<!-- -->
...
![](0.inspect-profiles_files/figure-gfm/unnamed-chunk-24-2.png)<!-- -->
...
![](0.inspect-profiles_files/figure-gfm/unnamed-chunk-24-3.png)<!-- -->
...
![](0.inspect-profiles_files/figure-gfm/unnamed-chunk-26-1.png)<!-- -->
