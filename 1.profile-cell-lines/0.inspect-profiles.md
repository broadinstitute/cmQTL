...
![](0.inspect-profiles_files/figure-gfm/unnamed-chunk-23-1.png)<!-- -->

``` r
plot_and_save_similarities(similarity = similarity_colony, profile_type = "colony")
```

![](0.inspect-profiles_files/figure-gfm/unnamed-chunk-23-2.png)<!-- -->

``` r
plot_and_save_similarities(similarity = similarity_isolated, profile_type = "isolated")
```

![](0.inspect-profiles_files/figure-gfm/unnamed-chunk-23-3.png)<!-- -->
