...
parallel \
  ...
  --max-procs 2 \
  -C "," \
  cp ../../../backend/{1}/{2}/{2}{3}.csv profiles/ ::: _augmented _colony _colony_augmented _colony_normalized _colony_normalized_variable_selected _count _isolated _isolated_augmented _isolated_normalized _isolated_normalized_variable_selected _normalized _normalized_variable_selected
