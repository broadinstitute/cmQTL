...
```
    ...
    ##    name                                            n
    ##    <chr>                                       <int>
    ##  1 Cells_Correlation_Overlap_DNA_Mito             12
    ##  2 Cells_Location_Center_X                         9
    ##  3 Cells_Location_Center_Y                         9
    ##  4 Cells_Location_Center_Z                         9
    ##  5 Cells_Texture_AngularSecondMoment_AGP_10_00     9
    ##  6 Cells_Texture_AngularSecondMoment_AGP_10_01     9
    ##  7 Cells_Texture_AngularSecondMoment_AGP_10_02     9
    ##  8 Cells_Texture_AngularSecondMoment_AGP_10_03     9
    ##  9 Cells_Texture_AngularSecondMoment_AGP_20_00     9
    ## 10 Cells_Texture_AngularSecondMoment_AGP_20_01     9
