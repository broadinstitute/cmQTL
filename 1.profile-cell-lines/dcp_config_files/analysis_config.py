...
APP_NAME = '2018_06_05_cmQTL_Analysis'                # Used to generate derivative names unique to the application.
...
EXPECTED_NUMBER_FILES = 4    #What is the number of files that trigger skipping a job?
